...
def companySwitch_test():
    driver.find_element_by_xpath("/html/body/div[2]/div/div/div[1]/div/div[1]/div[2]/div/ul/li[1]/a/span").click()
    time.sleep(3)
    driver.find_element_by_xpath("/html/body/div[2]/div/div/div[1]/div/div[1]/div[2]/div/ul/li[1]/div/ul/li[4]/a/div/span[2]").click()
    time.sleep(3)
    driver.find_element_by_xpath("/html/body/div[2]/div/div/div[1]/div/div[1]/div[2]/div/ul/li[1]/a/span").click()
    time.sleep(3)
    driver.find_element_by_xpath("/html/body/div[2]/div/div/div[1]/div/div[1]/div[2]/div/ul/li[1]/div/ul/li[13]/a/div/span[2]").click()
    time.sleep(3)
